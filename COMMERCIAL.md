...
Document details in `EVAL_LICENSE.md` if you provide this.

## Where are the legal terms?

Commercial terms live in:

- `commercial/COMMERCIAL_LICENSE_TEMPLATE.md` (template starting point)
- `commercial/ORDER_FORM_TEMPLATE.md` (template starting point)
