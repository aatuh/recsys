...
5. **Dry-run rules** – For manual overrides, call `/v1/admin/rules/dry-run` or the helper script before rollout (`docs/rules-runbook.md`).
...
- **Operational runbook for overrides & incidents:** `docs/rules-runbook.md`
