...
/**
 * Privacy Policy View for RecSys Web UI
 *
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "20px" }}>
      ...
      >
        <p style={{ margin: "8px 0 0 0", fontSize: 14, color: "#6c757d" }}>
          This privacy policy describes how the RecSys API collects, uses, and
          protects your information when using our recommendation system.
        </p>
      </div>
