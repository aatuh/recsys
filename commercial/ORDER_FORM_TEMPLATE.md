...
This Order Form is governed by and incorporates the **Commercial License Agreement (Recsys) v<version>** ("Agreement"). Capitalized terms not defined here have the meaning given in the Agreement.
...
### 1.4 Taxes
Customer is responsible for applicable VAT/sales taxes unless a valid exemption applies. Customer VAT ID: <VAT_ID>
