...
- **Ticket:** Introduce application composition root with dependency injection  
...
- **Ticket:** Replace panic-driven env loading with typed config provider and defaults  
...
- **Ticket:** Enforce strict tenant isolation instead of silent fallback to default org  
...
- **Ticket:** Add authentication, authorization, and rate limiting guardrails  
...
- **Ticket:** Harden request handling with size limits, strict decoders, and validation  
...
- **Ticket:** Strengthen CORS configuration safety  
  **Category:** Security  
