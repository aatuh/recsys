    ...
    <Section title="Reward Feedback">
      <div style={{ marginBottom: 16 }}>
          ...
          <Label text="Send Reward Feedback">
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
              <Button
                ...
                style={{
                  backgroundColor: reward === true ? "#28a745" : "#28a745",
                  color: "white",
                  border: "none",
                  padding: "8px 16px",
                  borderRadius: 4,
              ...
              <Button
                ...
                disabled={!canSendReward || loading}
                style={{
                  backgroundColor: reward === false ? "#dc3545" : "#dc3545",
                  color: "white",
                  border: "none",
                  padding: "8px 16px",
                  borderRadius: 4,
        ...
        {reward !== null && (
          <div
            style={{
              backgroundColor: reward ? "#d4edda" : "#f8d7da",
              color: reward ? "#155724" : "#721c24",
              border: `1px solid ${reward ? "#c3e6cb" : "#f5c6cb"}`,
              borderRadius: 4,
              padding: 12,
              marginBottom: 16,
              fontSize: 14,
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span
                        style={{
                          backgroundColor: entry.reward ? "#28a745" : "#dc3545",
                          color: "white",
                          padding: "2px 6px",
                          borderRadius: 2,
                          fontSize: 10,
                      ...
                      <span
                        style={{
                          backgroundColor: entry.success
                            ? "#d4edda"
                            : "#f8d7da",
                          color: entry.success ? "#155724" : "#721c24",
                          padding: "2px 6px",
                          borderRadius: 2,
                          fontSize: 10,
                          fontWeight: "bold",
                  ...
                  {entry.error && (
                    <div
                      style={{ fontSize: 10, color: "#dc3545", marginTop: 4 }}
                    >
