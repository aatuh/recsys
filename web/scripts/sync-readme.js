...
/**
 * Sync README files from various directories to the web public folder
 * This script ensures the documentation in the web UI is always up-to-date
 */
...
const readmeSources = [
  ...
  {
    source: path.join(PROJECT_ROOT, "web", "README.md"),
    target: "readme-web.md",
    name: "Web UI",
  },
  {
