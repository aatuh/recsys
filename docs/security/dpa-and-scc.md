...
- Subprocessor and delivery disclosures are published in:
...
- Security posture and controls: [Security, privacy, compliance](../start-here/security-privacy-compliance.md)
...
- Subprocessor and delivery disclosure: [Subprocessors and distribution details](subprocessors.md)
- Standard support schedule: [SLA and support schedule](sla-schedule.md)
- Commercial order form: [Order form template](../licensing/order_form.md)
