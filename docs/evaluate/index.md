...
[Guided evaluation](guided-evaluation.md){ .md-button }
...
- A guided customer-environment pilot path after the proof kit
...
RecSys does not currently offer a hosted evaluation sandbox. The supported commercial path is local proof kit first,
then a guided pilot in your own customer-controlled environment:
[Guided evaluation](guided-evaluation.md).
...
- [ ] If you want guided help, prepare the customer-environment intake:
  [Guided evaluation](guided-evaluation.md)
...
- Guided evaluation path: [Guided evaluation](guided-evaluation.md)
