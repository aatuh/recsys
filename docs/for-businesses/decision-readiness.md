...
| Enterprise readiness | If Enterprise is requested, have HA, support, security, and operational gaps been reviewed? | [Enterprise readiness evidence](enterprise-readiness-evidence.md), [Production readiness checklist](../operations/production-readiness-checklist.md) | Yes for Enterprise/custom commitments | Eng manager + Security + SRE | ☐ Ready ☐ Needs clarification ☐ Blocked |
