...
- **Commercial Evaluation (30 days)**  
  ...
  **Includes:** evaluation license + access to signed commercial artifacts (if applicable).
...
- **Starter**  
  ...
  **Includes:** commercial license grant, signed artifacts, updates, best-effort async support.
...
- **Growth**  
  ...
  **Includes:** everything in Starter + faster async response target (typically within 2 business days).

- **Enterprise**  
  From €60,000 / year  
  **Who it’s for:** multi-region HA, OEM/resale, regulated environments, or custom terms.  
  **Scope:** custom.  
  **Includes:** custom scope/terms + optional premium support/security commitments.

</div>

## Optional add-ons (Growth/Enterprise)
