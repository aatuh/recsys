...
By submitting a contribution, you agree that your contribution is licensed under the **same license as the component**
you are contributing to (Apache-2.0 for `recsys-eval`, AGPLv3 for the serving stack), unless otherwise agreed in writing.

### Commercial dual-licensing note (important)

If we accept code contributions into the AGPL-covered components and later want to include them in commercial distributions,
we may require an additional contributor agreement for those specific contributions.
